...
export class Backend implements backendInterface {
    ...
    async addEvent(arg0: string, arg1: string, arg2: Time, arg3: string, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async addGalleryItem(arg0: string, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getGalleryItem(arg0: bigint): Promise<GalleryItem> {
        if (this.processError) {
            try {
    ...
    async submitContactMessage(arg0: string, arg1: string, arg2: string, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
